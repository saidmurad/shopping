    ...
    <div class="row pt-5">
      <div class="col-5 pr-5">
        ...
        <div>
            ...
            <div class="d-flex align-items-center"  >
                <div  style="width:20%"><span> {{user.id}}</span></div>
                <div  style="width:60%"><span> {{user.firstName}} {{user.lastName}}</span></div>
               <div  style="width:20%"><button class="btn btn-primary" @click="showUser(user.id)" > <span> Detail</span> </button></div>
     ...
     <div class="container">
          ...
          <img
            ...
            alt="image"
          />
          <p class="user-name"><span class="profile-title">{{firstName}} {{lastName}}</span></p>
          <p class="user-phoneNumber">Phone Number: <span class="profile-title">{{phoneNumber}}</span></p>
           <p class="user-email">Email: <span class="profile-title">{{email}}</span></p>
            <p class="user-sex">Sex: <span class="profile-title">{{sex}}</span></p>
             <p class="user-sex">Rate: <span class="profile-title">{{rate}}</span></p>
           
          </div>  
          
          <form
      action="#"
      @submit.prevent="giveRate()">
      <div class="form-group">
        <label> Rate</label>
        <input v-model="addedRate" type="text" name="name" class="form-control" />
      </div>
      <div class="form-group">
        <button  type="submit" class="btn btn-primary">Give Rate</button>
