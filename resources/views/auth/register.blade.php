                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('sex') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="sex" type="text" class="form-control" name="sex" value="{{ old('name') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('phoneNumber') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="phoneNumber" type="text" class="form-control" name="phoneNumber" value="{{ old('name') }}" required autofocus>
